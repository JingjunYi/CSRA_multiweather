...
def Args():
    ...
    # model
    parser.add_argument("--model", default="vit_B16_224") # resnet101
    parser.add_argument("--num_heads", default=1, type=int)
    parser.add_argument("--lam",default=0.1, type=float)
    parser.add_argument("--cutmix", default=None, type=str) # the path to load cutmix-pretrained backbone
    # dataset
    parser.add_argument("--dataset", default="multiweather", type=str)
    ...
    parser.add_argument("--img_size", default=224, type=int) # 448
...
def main():
    ...
    if args.dataset == "multiweather":
        train_file = ['data/multiweather/trainval_multiweather.json']
        test_file = ["data/multiweather/test_multiweather.json"]
        step_size = 4
    ...
    for i in range(1, args.total_epoch + 1):
        ...
        if not os.path.exists(args.checkpoint+"/{}".format(args.model)):
            os.mkdir(args.checkpoint+"/{}".format(args.model))
        torch.save(model.state_dict(), args.checkpoint+"/{}/epoch_{}.pth".format(args.model, i))
